...
async function handleSearch() {
  ...
  // 🎉 Construction typo corrections
  const typoCorrections = {
    'duck':    { title: '🦆 Quack!', msg: 'Did you mean "duct"? This is a construction site, not a pond!' },
    'bear':    { title: '🐻 Rawr!', msg: 'Did you mean "beam"? No bears on this job site... we hope.' },
    'bowel':   { title: '😳 Uh oh...', msg: 'Did you mean "bolt"? Let\'s keep things professional here.' },
    'steal':   { title: '🦹 Stop right there!', msg: 'Did you mean "steel"? We build things here, not steal them!' },
    'led':     { title: '✏️ Pencil pusher?', msg: 'Did you mean "lead" (the metal)? Or maybe "LED" (the light)?' },
    'flour':   { title: '🧁 Wrong site!', msg: 'Did you mean "floor"? The bakery is next door.' },
    'bored':   { title: '😴 Same tbh', msg: 'Did you mean "board"? We get it, meetings are long.' },
    'plain':   { title: '✈️ Taking off?', msg: 'Did you mean "plane" (the tool)? Or "plain" concrete?' },
    'ceiling': { title: '🎵 Sealed with a kiss?', msg: 'Did you mean "sealing"? Or is the ceiling actually what you want?' },
  };

  const typo = typoCorrections[query.toLowerCase()];
  if (typo) {
    showEmpty(true, typo.title, typo.msg);
    photoGrid.innerHTML = '';
