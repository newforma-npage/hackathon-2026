...
async function handleSearch() {
  ...
  const easterEggs = {
    ...
    'gutter':    { emoji: '🎳', title: '🎳 Gutter ball!', msg: 'Looking for roof gutters? Or did you mean "grout"? Searching gutters...' },
    'rebar':     { emoji: '🍫', title: '🍫 Snack time?', msg: '"Rebar" not "Re-bar" the chocolate. Searching reinforcement...' },
    'stud':      { emoji: '😏', title: '😏 Hey there!', msg: 'Looking for wall studs? We found one right here. Searching...' },
    'joint':     { emoji: '🦴', title: '🦴 Crack!', msg: 'Expansion joint? Control joint? Searching all joints...' },
    'caulk':     { emoji: '🤫', title: '🤫 Careful how you say that...', msg: 'Searching for caulking and sealant photos...' },
    'stripper':  { emoji: '🎨', title: '🎨 Paint stripper!', msg: 'We\'re talking paint strippers here. Keep it PG. Searching...' },
    'flashing':  { emoji: '📸', title: '📸 Say cheese!', msg: 'Roof flashing, not that kind. Searching waterproofing details...' },
    'erection':  { emoji: '🏗️', title: '🏗️ Steel erection!', msg: 'It\'s a legitimate construction term! Searching structural steel...' },
    'ballcock':  { emoji: '🚽', title: '🚽 Plumbing time!', msg: 'A ballcock is a toilet valve mechanism. Searching plumbing...' },
    'butt':      { emoji: '🪵', title: '🪵 Butt joint!', msg: 'A butt joint is where two pieces meet end-to-end. Searching...' },
    'coping':    { emoji: '🧘', title: '🧘 Deep breaths...', msg: 'Coping is the cap on a wall. Also a life skill on construction sites. Searching...' },
    'fascia':    { emoji: '💆', title: '💆 Spa day?', msg: 'Fascia board, not facial. Searching exterior trim...' },
    'mortar':    { emoji: '💣', title: '💣 Incoming!', msg: 'Mortar for bricks, not the battlefield kind. Searching masonry...' },
    'purlin':    { emoji: '🐱', title: '🐱 Purr-lin?', msg: 'A purlin supports the roof. Cats are not structural. Searching...' },
    'soffit':    { emoji: '🛋️', title: '🛋️ So-fit?', msg: 'Soffit — the underside of an overhang. Not a couch. Searching...' },
    ...
    'grout':     { emoji: '💪', title: '💪 Grout job!', msg: '"Grout" is correct! Searching tile and masonry...' },
